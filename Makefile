...
server: src/server.c src/path.h src/path.c src/alloc.h src/utils.h src/alloc.c src/utils.c
	gcc -o bin/server src/server.c src/path.h src/path.c src/alloc.h src/utils.h src/alloc.c src/utils.c
